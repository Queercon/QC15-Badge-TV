...
namespace se.nightri.QC15_TV_Badge
{
    public partial class StartFrame : Form
    {
        ...
        public String[] critical = new String[9];
        ...
        {
            string sqlQuery = "SELECT TOP (8) [id0], [badgename], [badges_connected] FROM [badge].[dbo].[badgestats] WHERE [lastseen] >= DATEADD(s, -" + timeRefreshInt + ", SYSDATETIME()) ORDER By [badges_connected] DESC";
        ...
        {
            string sqlQuery = "SELECT TOP (8) [id0], [badgename], [badges_connected] FROM [badge].[dbo].[badgestats] ORDER By [badges_connected] DESC";
